...
const driverSlice = createSlice({
  ...
  initialState,
  reducers: {
    signInDriverStart: (state) => { state.loading = true; },
    ...
    updateDriverStart: (state) => { state.loading = true; },
    ...
    deleteDriverStart: (state) => { state.loading = true; },
    ...
    signOutDriverStart: (state) => { state.loading = true; },
...
export default driverSlice.reducer; // ✅ make sure this is here
